...
public class ChapterIndex {
    ...
    let chapterNested = [["a. Epidemiology"],["a. Introduction","b. Tuberculin Skin Test (TST)","c. Criteria for a Positive Tuberculin Test, by Risk Group","d. Two-Step Testing and the Booster Reaction","e. Anergy Testing","f. Interferon-γ Release Assays (IGRAs)","g. Targeted Testing and Diagnostic Tests for LTBI","h. Medical Evaluation After Testing for LTBI","i. Reporting of Pediatric Positive Tests for LTBI"],["a. Introduction","b. Treatment Regimens","c. Monitoring of Patients on Treatment for LTBI","d. Contacts of MDR-TB Cases"],["a. Introduction","b. Considerations","c. Selected Diagnostic Test Characteristics","d. Laboratory Diagnosis of Pulmonary Tuberculosis","c. Laboratory Diagnosis of Extrapulmonary Tuberculosis","e. Rapid Molecular Drug Susceptibility Tests (DST)"],["a. Introduction","b. Considerations","c. Standard Therapy for Current (Active) Disease","d. Special Clinical Situations","e. Drug Resistance","f. Monitoring Patients on Therapy for Response and Adverse Events","g. TB and HIV","h. Immune Reconstitution Inflammatory Syndrome (IRIS) Associated with Initiation of Antiretroviral Therapy During the Course of TB Therapy","i. Treatment of Extrapulmonary TB (Table 19)","j. Adjunctive Use of Corticosteroid Therapy (Table 19)"],["a. Introduction","b. Treatment for LTBI and Risk Factors","c. Treatment of Active TB in Pregnancy"],["a. Introduction","b. Management Considerations"],["a. Tuberculosis and Long-Term Care Facilities"],["a. BCG Vaccination"],["a. Introduction","b. Administrative Controls","c. Surveillance for Health Care Workers","d. Environmental Controls","e. Personal Respiratory Protection"],["a. Introduction","b. TB Surveillance in Georgia","c. How to Report TB as a Notifiable Disease","d. Role of the Health Department","e. TB Case Definitions for Public Health Surveillance","f. Hospital Discharge Planning for Patients with Suspected or Proven TB","g. Interjurisdictional TB Notification (IJN)","h. CureTB Program (International Linkage to TB Care)"],["a. Alternative Housing Program for Homeless TB Patients in Georgia"],["a. Georgia Department of Public Health (DPH) Community Guidelines for Respiratory Isolation of Patients with Active TB in the Community"],["References"],["Appendix: District TB Coordinators (by District)"],["Abbreviations"],["Acknowledgements"],["Hello and Welcome Clinical Statement"],["For more information"],["Table 1: Interpretation Criteria for the QuantiFERON-TB Gold Plus Test (QFT-Plus)","Table 2: Interpretation Criteria for the T-SPOT.TB Test (T- Spot)","Table 3: High Prevalence and High-Risk Groups","Table 4: Recommendations for regimens to treat latent tuberculosis infection","Table 5: Dosages for recommended LTBI treatment regimens","Table 6: LTBI Treatment Drug Adverse Reactions","Table 7: Recommended Regimens for Treatment of Adults and Children with Drug Susceptible Pulmonary TB","Table 8: First-Line TB Drugs: Dosing for Adults (ages 16 and over) Directly Observed Therapy (DOT) is mandatory","Table 9: Pediatric Dosages - Isoniazid in Children (birth to 15 years)","Table 10: Pediatric Dosages - Rifampin in Children (birth to 15 years)","Table 11: Pediatric Dosages - Ethambutol in Children (birth to 15 years)","Table 12: Pediatric Dosages - Pyrazinamide in Children (birth to 15 years)","Table 13: Antituberculosis Antibiotics in Adult Patients with Renal Impairement","Table 14: Antituberculosis Medications with may be used for Patients who have Contraindications to or Intolerance of First Line Agents of who require IV Therapy during Acute or Critical Illness","Table 15: Clinical Situations for which Standard Therapy cannot be given or is not well-tolerated or may not be effective: Potential Alternative Regimens (Dosing and/or Drugs)","Table 16: When to start HIV Therapy","Table 17: What to start: Choice of TB Therapy and Antiretroviral Therapy (ART) when treating Co-infected Patients","Table 18: Dosage Adjustments for ART and Rifamycins when used in Combination","Table 19: Guidelines for Treatment of Extrapulmonary Tuberculosis: Length of Therapy and Adjunctive Use of Corticosteroids","Table 20: Use of Anti-TB Medications in Special Situations: Pregnancy, Tuberculosis Meningitis and Renal Failure","Table 21: Grady Isolation Policy","Figure 1. Factors to be considered in deciding to initiate treatment empirically for active tuberculosis (TB) (prior to microbiologic confirmation)"]]
	...
	let chartNested = [
		...
		["Table 9: Pediatric Dosages - Isoniazid in Children (birth to 15 years)"],
		...
		["Table 14: Antituberculosis Medications with may be used for Patients who have Contraindications to or Intolerance of First Line Agents or who require IV Therapy during Acute or Critical Illness"],
    ...
    let subChapterNames = [
      ...
      "Criteria for a Positive Tuberculin Test, by Risk Group",
      "Two-Step Testing and the Booster Reaction",
      "Anergy Testing",
      "Interferon-γ Release Assays (IGRAs)",
      "Targeted Testing and Diagnostic Tests for LTBI",
      "Medical Evaluation After Testing for LTBI",
      "Reporting of Pediatric Positive Tests for LTBI",
      "Introduction",
      "Treatment Regimens",
      "Monitoring of Patients on Treatment for LTBI",
      "Contacts of MDR-TB Cases",
      "Introduction",
      "Considerations",
      "Selected Diagnostic Test Characteristics",
      "Laboratory Diagnosis of Pulmonary Tuberculosis",
      "Laboratory Diagnosis of Extrapulmonary Tuberculosis",
      ...
      "Table 11: Pediatric Dosages - Ethambutol in Children (birth to 15 years)",
      "Table 12: Pediatric Dosages - Pyrazinamide in Children (birth to 15 years)",
      "Table 13: Antituberculosis Antibiotics in Adult Patients with Renal Impairement",
      "Table 14: Antituberculosis Medications with may be used for Patients who have Contraindications to or Intolerance of First Line Agents of who require IV Therapy during Acute or Critical Illness",
      "Table 15: Clinical Situations for which Standard Therapy cannot be given or is not well-tolerated or may not be effective: Potential Alternative Regimens (Dosing and/or Drugs)",
      "Table 16: When to start HIV Therapy",
      "Table 17: What to start: Choice of TB Therapy and Antiretroviral Therapy (ART) when treating Co-infected Patients",
      "Table 18: Dosage Adjustments for ART and Rifamycins when used in Combination",
	...
	let chapterURLs = [
		"i_epidemiology",
		"ii_diagnostic_tests_for_latent_tb_infection_(ltbi)",
		"iii_treatment_of_latent_tb_infection_(ltbi)",
		"iv_laboratory_diagnosis_of_active_tuberculosis",
		"v_treatment_of_current_(active)_disease_therapy",
		"vi_pregnancy_and_tb",
		"vii_childhood_tuberculosis",
		"viii_tuberculosis_and_long-term_care_facilities",
		"ix_bcg_vaccination",
		"x_tb_infection_control_hospital_isolation_procedures",
		"xi_community_tuberculosis_control",
		"xii_alternative_housing_program_for_homeless_tb_patients_in_georgia",
		"xiii_georgia_department_of_public_health_(dph)_community_guidelines_for_respiratory_isolation_of_patients_with_active_tb_in_the_community",
		"xiv_references",
		"xv_appendix_district_tb_coordinators_(by_district)",
		"xvi_abbreviations",
		"xvii_acknowledgements",
		"xviii_hello_and_welcome_clinical_statement",
		"xix_for_more_information"
	]
    ...
    let chaptermapsubchapternested = [
      "a. Epidemiology",

      "a. Introduction",
      "b. Tuberculin Skin Test (TST)",
      "c. Criteria for a Positive Tuberculin Test, by Risk Group",
      "d. Two-Step Testing and the Booster Reaction",
      "e. Anergy Testing",
      "f. Interferon-γ Release Assays (IGRAs)",
      "g. Targeted Testing and Diagnostic Tests for LTBI",
      "h. Medical Evaluation After Testing for LTBI",
      "i. Reporting of Pediatric Positive Tests for LTBI",

      "a. Introduction",
      "b. Treatment Regimens",
      "c. Monitoring of Patients on Treatment for LTBI",
      "d. Contacts of MDR-TB Cases",

      "a. Introduction",
      "b. Considerations",
      "c. Selected Diagnostic Test Characteristics",
      "d. Laboratory Diagnosis of Pulmonary Tuberculosis",
      "c. Laboratory Diagnosis of Extrapulmonary Tuberculosis",
      "e. Rapid Molecular Drug Susceptibility Tests (DST)",
      ...
      "c. Treatment of Active TB in Pregnancy",

      "a. Introduction",
      "b. Management Considerations",

      "a. Tuberculosis and Long-Term Care Facilities",

      "a. BCG Vaccination",

      "a. Introduction",
      "b. Administrative Controls",
      "c. Surveillance for Health Care Workers",
      "d. Environmental Controls",
      "e. Personal Respiratory Protection",

      "a. Introduction",
      "b. TB Surveillance in Georgia",
      "c. How to Report TB as a Notifiable Disease",
      "d. Role of the Health Department",
      "e. TB Case Definitions for Public Health Surveillance",

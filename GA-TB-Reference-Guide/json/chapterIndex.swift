...
public class ChapterIndex {
    ...
    "XIV. References","XV. Appendix: District TB Coordinators (by District)","XVI. For more information",
    "II. Diagnos􏰀tic Tests for Latent TB Infecti􏰀on (LTBI)",
    "II. Diagnosti􏰀c Tests for Latent TB Infecti􏰀on (LTBI)",
    "II. Diagnosti􏰀c Tests for Latent TB Infecti􏰀on (LTBI)",
    "III. Treatment of Latent TB Infection (LTBI)",
    "III. Treatment of Latent TB Infection (LTBI)",
    "III. Treatment of Latent TB Infection (LTBI)",
    ...
    "V. Treatment of Current (Active) Disease Therapy",
    "V. Treatment of Current (Active) Disease Therapy",
    "VI. Pregnancy and TB","X. TB Infection Control: Hospital Isolation Procedures"]
...
let JSON = """
    ...
    {
      "chapterId": "2",
      "subChapterTitle": "Interferon-? Release Assays (IGRAs)",

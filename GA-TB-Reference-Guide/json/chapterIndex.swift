...
public class ChapterIndex {
  let chapterNested = [
    ...
    ["a. Epidemiology"],
    [
      "a. Introduction", "b. Tuberculin Skin Test (TST)",
      "c. Criteria for a Positive Tuberculin Test, by Risk Group",
      "d. Two-Step Testing and the Booster Reaction", "e. Anergy Testing",
      "f. Interferon-γ Release Assays (IGRAs)", "g. Targeted Testing and Diagnostic Tests for LTBI",
      "h. Medical Evaluation After Testing for LTBI",
      "i. Reporting of Pediatric Positive Tests for LTBI",
    ],
    [
      "a. Introduction", "b. Treatment Regimens", "c. Monitoring of Patients on Treatment for LTBI",
      "d. Contacts of MDR-TB Cases",
    ],
    [
      "a. Introduction", "b. Considerations", "c. Selected Diagnostic Test Characteristics",
    ...
    ], ["a. Introduction", "b. Management Considerations"],
    ["a. Tuberculosis and Long-Term Care Facilities"], ["a. BCG Vaccination"],
    [
      "a. Introduction", "b. Administrative Controls", "c. Surveillance for Health Care Workers",
      "d. Environmental Controls", "e. Personal Respiratory Protection",
    ],
    [
      "a. Introduction", "b. TB Surveillance in Georgia",
      "c. How to Report TB as a Notifiable Disease", "d. Role of the Health Department",
    ...
    [
      ...
      "Table 11: Antituberculosis Medications for Patients who have Contraindications to or Intolerance of First Line Agents or require IV Therapy during Acute or Critical Illness.",
      ...
      "Table 13: When to Start HIV Therapy",
      "Table 14: What to start: Choice of TB Therapy and Antiretroviral Therapy (ART) when treating Co-infected Patients",
  ...
  let chapterCode = [
    ...
    [
      ...
      "4_laboratory_diagnosis_of_active_tuberculosis__e__rapid_molecular_drug_susceptibility_tests_(dst)",
    ],
    [
      "5_treatment_of_current_(active)_disease_therapy",
      "5_treatment_of_current_(active)_disease_therapy__a__considerations",
      "5_treatment_of_current_(active)_disease_therapy__b__standard_therapy_for_current_(active)_disease",
      "5_treatment_of_current_(active)_disease_therapy__c__special_clinical_situations",
      "5_treatment_of_current_(active)_disease_therapy__d__drug_resistance",
      "5_treatment_of_current_(active)_disease_therapy__e__monitoring_patients_on_therapy_for_response_and_adverse_events",
      "5_treatment_of_current_(active)_disease_therapy__f__tb_and_hiv",
      "5_treatment_of_current_(active)_disease_therapy__h__immune_reconstitution_inflammatory_syndrome",
    ...
    ], ["7_childhood_tuberculosis", "7_childhood_tuberculosis__a__management_considerations"],
    ["8_tuberculosis_and_long_term_care_facilities"], ["9_bcg_vaccination"],
    [
      "10_tb_infection_control_hospital_isolation_procedures",
      "10_tb_infection_control_hospital_isolation_procedures__a__administrative_controls",
      "10_tb_infection_control_hospital_isolation_procedures__b__surveillance_for_health_care_workers",
    ...
    [
      ...
      "11_community_tuberculosis_control__a__tb_surveillance_in_georgia",
      "11_community_tuberculosis_control__b__how_to_report_tb_as_a_notifiable_disease",
      ...
      "11_community_tuberculosis_control__f__interjurisdictional_tb_notification(ijn)",
      "11_community_tuberculosis_control__g__curetb_program_(internation_linkage_to_tb_care)",
    ], ["12_alternative_housing_program_for_homeless_tb_patients_in_georgia"],
    ["13_georgia_department_of_public_health_(dph)_community_guidelines_for_respiratory"],
    ["14_references"], ["15_appendix_district_tb_coordinators_(by_district)"],
    ["16_abbreviations"], ["17_acknowledgements"],
    ["18_for_more_information"],
    [
      "table_1_interpretation_criteria_for_the_quantiferon_tb_gold_plus_test",
      "table_2_interpretation_criteria_for_the_t_spot_tb_test",
      "table_3_high_prevalence_and_high_risk_groups",
      "table_4_recommendations_for_regimens_to_treat_latent_tuberculosis_infection",
      "table_5_dosages_for_recommended_lbti_treatment_regimens",
      "table_6_ltbi_treatment_drug_adverse_reactions",
      "table_7_recommended_regimens_for_treatment_of_adults_and_children_with_drug_susceptible_tb_pulmonary_tb",
      "table_8_first-line_tb_drugs_dosing_for_adults_(ages_16_and_over)_directly_observed_therapy_(dot)_is_mandatory",
